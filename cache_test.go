...
func TestIncrementWithUint(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint", uint(1), DefaultExpiration)
	err := tc.Increment("tint", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
...
func TestIncrementWithUnsafeIntPtr(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("lintptr", uintptr(1), DefaultExpiration)
	err := tc.Increment("lintptr", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}

	x, found := tc.Get("lintptr")
	if !found {
		t.Error("lintptr was not found")
	}
	if x.(uintptr) != 3 {
		t.Error("lintptr is not 3:", x)
	}
}

func TestIncrementWithUint8(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint8", uint8(1), DefaultExpiration)
	err := tc.Increment("tint8", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
...
func TestIncrementWithUint16(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint16", uint16(1), DefaultExpiration)
	err := tc.Increment("tint16", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
...
func TestIncrementWithUint32(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint32", uint32(1), DefaultExpiration)
	err := tc.Increment("tint32", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
...
func TestIncrementWithUint64(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint64", uint64(1), DefaultExpiration)
	err := tc.Increment("tint64", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
...
func TestIncrementWithFloat64(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("float64", 1.5, DefaultExpiration)
...
func TestIncrementFloatWithFloat32(t *testing.T) {
	...
	if err != nil {
		t.Error("Error increment-floating:", err)
	}
	x, found := tc.Get("float32")
	if !found {
		t.Error("float32 was not found")
...
func TestDecrementWithUnsafeIntPtr(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("lintptr", uintptr(5), DefaultExpiration)
	err := tc.Decrement("lintptr", 2)
	if err != nil {
		t.Error("Error decrementing:", err)
	}
	x, found := tc.Get("lintptr")
...
func TestDecrementWithFloat64(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("float64", 5.5, DefaultExpiration)
...
func TestIncrementUnsafeIntPtr(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("lintptr", uintptr(1), DefaultExpiration)
	n, err := tc.IncrementUnsafeIntPtr("lintptr", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
	if n != 3 {
...
func TestIncrementUint8(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint8", uint8(1), DefaultExpiration)
	n, err := tc.IncrementUint8("tint8", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
	if n != 3 {
...
func TestIncrementUint16(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint16", uint16(1), DefaultExpiration)
	n, err := tc.IncrementUint16("tint16", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
	if n != 3 {
...
func TestIncrementUint32(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint32", uint32(1), DefaultExpiration)
	n, err := tc.IncrementUint32("tint32", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
	if n != 3 {
...
func TestIncrementUint64(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("tint64", uint64(1), DefaultExpiration)
	n, err := tc.IncrementUint64("tint64", 2)
	if err != nil {
		t.Error("Error incrementing:", err)
	}
	if n != 3 {
...
func TestDecrementUnsafeIntPtr(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("lintptr", uintptr(5), DefaultExpiration)
	n, err := tc.DecrementUnsafeIntPtr("lintptr", 2)
	if err != nil {
		t.Error("Error decrementing:", err)
	}
	if n != 3 {
...
func TestIncrementOverflowInt(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("i", int8(127), DefaultExpiration)
	err := tc.Increment("i", 1)
	if err != nil {
		t.Error("Error incrementing i:", err)
	}
	x, _ := tc.Get("i")
	i := x.(int8)
	if i != -128 {
		t.Error("i did not overflow as expected; value:", i)
	}
...
func TestIncrementOverflowUint(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("u", uint8(255), DefaultExpiration)
	err := tc.Increment("u", 1)
	if err != nil {
	...
	u := x.(uint8)
	if u != 0 {
		t.Error("u did not overflow as expected; value:", u)
	}
}

func TestDecrementUnderflowUint(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	tc.Set("u", uint8(0), DefaultExpiration)
	err := tc.Decrement("u", 1)
	if err != nil {
	...
	u := x.(uint8)
	if u != 255 {
		t.Error("u did not underflow as expected; value:", u)
	}
}
...
func TestCacheSerialization(t *testing.T) {
	...
	// Check if gobbed.Register behaves properly even after multiple gob.Register
...
func TestFileSerialization(t *testing.T) {
	tc := New(DefaultExpiration, 0)
	err := tc.Add("a", "a", DefaultExpiration)
	if err != nil {
		return
	}
	err = tc.Add("b", "b", DefaultExpiration)
	if err != nil {
		return
	}
